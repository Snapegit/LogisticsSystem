	...
	<div>
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				<div class="list_item">
					<div class="list_label">司机账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.sijizhanghao" 
						 placeholder="请输入司机账号"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">司机姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.sijixingming" 
						 placeholder="请输入司机姓名"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					...
					<el-select 
						...
						placeholder="请选择性别"
						>
						<el-option v-for="item in sijixingbieLists" :label="item" :value="item"></el-option>
					</el-select>
				</div>
...
<script setup>
	...
	const sijixingbieLists = ref([])
	const init=()=>{
		sijixingbieLists.value = "男,女".split(',')
	}
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.sijizhanghao)){
		...
		if((!registerForm.value.sijixingming)){
