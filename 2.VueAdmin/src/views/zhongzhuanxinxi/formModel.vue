				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="司机账号" prop="sijizhanghao">
							<el-input class="list_inp" v-model="form.sijizhanghao" placeholder="司机账号"
								 type="text" 								:readonly="!isAdd||disabledForm.sijizhanghao?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="中转地点" prop="zhongzhuandidian">
							<el-input class="list_inp" v-model="form.zhongzhuandidian" placeholder="中转地点"
								 type="text" 								:readonly="!isAdd||disabledForm.zhongzhuandidian?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="中转时间" prop="zhongzhuanshijian">
							<el-date-picker
								class="list_date"
								v-model="form.zhongzhuanshijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.zhongzhuanshijian?true:false"
								placeholder="请选择中转时间" />
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	//基础信息
	const tableName = 'zhongzhuanxinxi'
	const formName = '中转信息'
	//基础信息
	//form表单
	const form = ref({})
	const disabledForm = ref({
		...
		shoujihaoma : false,
		chepaihao : false,
		zhongzhuandidian : false,
		zhongzhuanshijian : false,
	})
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.zhongzhuanshijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='zhongzhuandidian'){
					form.value.zhongzhuandidian = row[x];
					disabledForm.value.zhongzhuandidian = true;
					continue;
				}
				if(x=='zhongzhuanshijian'){
					form.value.zhongzhuanshijian = row[x];
					disabledForm.value.zhongzhuanshijian = true;
					continue;
				}
			}
			if(row){
