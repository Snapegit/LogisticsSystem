		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="订装费" prop="dingzhuangfei">
							<el-input class="list_inp" v-model.number="form.dingzhuangfei" placeholder="订装费"
								 type="number" 								:readonly="!isAdd||disabledForm.dingzhuangfei?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='dingzhuangfei'){
					form.value.dingzhuangfei = row[x];
					disabledForm.value.dingzhuangfei = true;
					continue;
				}
			}
			if(row){
